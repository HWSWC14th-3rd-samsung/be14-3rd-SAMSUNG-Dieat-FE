...
import PostDetailHeader from '../components/PostHeader.vue';
import PostContent from '../components/PostContent.vue';
import PostCommentInput from '../components/PostCommentInput.vue';
...
import { fetchPostById } from '@/features/readFree/api/freePostApi.js';
